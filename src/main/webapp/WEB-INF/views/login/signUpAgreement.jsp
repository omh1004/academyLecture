      	...
      	<div class="agreement-item">
      		...
      		<div class="agreement-content">
      			<div class="agreement-text overflow-auto">
		            ...
		            <ol>
		                <li>univora: 학부모들이 자녀 교육과 관련된 정보 교류, 커뮤니티 활동, 교육 자료 제공 등의 서비스를 이용할 수 있도록 구축된 온라인 커뮤니티 플랫폼.</li>
		                <li>이용자: 본 약관에 따라 univora가 제공하는 서비스를 이용하는 개인.</li>
		                <li>가입: univora가 제공하는 가입 신청 양식에 정보를 기입하고, 본 약관에 동의하여 서비스 이용 계약을 완료시키는 행위.</li>
		                <li>회원: univora에 개인정보를 제공하여 회원 등록을 한 자로서, univora가 제공하는 서비스를 이용할 수 있는 권한을 가진 개인.</li>
		                <li>비밀번호: 이용자와 회원의 ID가 일치하는지를 확인하고, 통신상의 개인 정보를 보호하기 위해 이용자가 설정한 문자와 숫자의 조합.</li>
		                <li>탈퇴: 회원이 이용계약을 종료시키는 행위.</li>
		                <li>서비스: univora가 구현하는 단말기(PC, 모바일 등 각종 유무선 장치를 포함)와 관계없이 회원이 이용할 수 있는 커뮤니티 기능, 정보 제공, 게시판 운영 및 기타 관련 서비스를 의미.</li>
		            </ol>
		
		            <strong>제2장 서비스 제공 및 이용</strong>
		            <strong>제3조 [약관의 효력과 변경]</strong>
		            <ol>
		                <li>univora는 본 약관의 내용을 "회원"이 쉽게 알 수 있도록 서비스 초기 화면에 게시합니다.</li>
		                <li>본 약관은 이용자가 약관 내용에 동의하고 회원 가입을 완료한 시점부터 효력이 발생하며, univora의 서비스 제공 및 회원의 서비스 이용에 본 약관이 우선적으로 적용됩니다.</li>
		                <li>univora는 관련 법률(전자상거래법, 약관의 규제에 관한 법률 등)을 준수하며, 필요 시 약관을 개정할 수 있습니다.</li>
		                <li>약관이 개정될 경우, univora는 개정된 약관의 적용일자 및 개정 사유를 명시하여 서비스 초기 화면에 최소 7일 전 공지하며, 기존 회원에게는 전자우편으로 개정 내용을 전달합니다.</li>
		            ...
		            <ol>
		                <li>이용계약은 이용자가 univora가 제공하는 가입 신청 양식에 정보를 기입하고, 약관에 동의한 후 회원 가입을 완료함으로써 성립됩니다.</li>
		                <li>univora는 아래의 경우 이용계약을 거부하거나 취소할 수 있습니다:
		                    <ol>
		                        <li>타인의 명의를 사용하여 가입 신청을 한 경우.</li>
		                        <li>허위 정보를 기재하거나 제출한 경우.</li>
		                        <li>univora의 서비스 운영을 고의로 방해한 경우.</li>
		                        <li>기타 univora가 정한 가입 요건을 충족하지 못한 경우.</li>
		                    </ol>
		                </li>
		            </ol>
		
		            <strong>제3장 회원과 univora의 의무</strong>
		            <strong>제6조 [univora의 의무]</strong>
		            <ol>
		                <li>univora는 회원의 개인 정보를 보호하며, 동의 없이 제3자에게 제공하지 않습니다.</li>
		                <li>univora는 회원이 안전하게 서비스를 이용할 수 있도록 기술적 보안 조치를 제공합니다.</li>
		            </ol>
		            ...
		            <ol>
		                <li>회원은 다음과 같은 행위를 해서는 안 됩니다:
		                    <ul>
		                        <li>허위 정보 제공.</li>
		                        <li>타인의 정보 도용.</li>
		                        <li>univora 서비스 방해 행위.</li>
		                        <li>저작권 및 지적재산권 침해.</li>
		                        <li>외설적 또는 폭력적 콘텐츠 게시.</li>
		                    </ul>
		                </li>
		                <li>회원은 본 약관, 서비스 이용 안내 및 univora의 공지 사항을 준수해야 합니다.</li>
		            </ol>
				</div>
        	</div>
